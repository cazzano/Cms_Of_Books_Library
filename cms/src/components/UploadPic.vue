  ...
  methods: {
    ...
    async uploadPicture() {
      ...
      try {
        ...
        const response = await fetch(`https://bookslibraryfileserver-production.up.railway.app/pictures?book_id=${this.selectedBook.books_id}`, {
          method: method,
          body: formData
        });
    ...
    async deletePicture() {
      ...
      try {
        const response = await fetch(`https://bookslibraryfileserver-production.up.railway.app/pictures?book_id=${this.bookForDelete.books_id}`, {
          method: 'DELETE'
        });
